...
export const KeepAlive = {
  ...
  setup(props, { slots }) {
    ...
    const cache = new Map(); // 缓存表  <keep-alive key="a"> <xx> <keep-alive>
    ...
    onMounted(cacheSubTree, console.log('mounted cache', cache));
    onUpdated(cacheSubTree, console.log('updated cache', cache));
